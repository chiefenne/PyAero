...
Go to the *Windows* folder and download *PyAero.zip*. Extract that file in an arbitrary location on the PC. There will be a file and a folder extracted, *PyAero.zipexe* and *data* respectively.
